...
from python_bingx.models.agent import PaginationParams
from python_bingx.models.spot.account import (
    AccountType,
...
class AccountAPI:
    ...
    def query_assets(
        ...
        return self.client.save_convert(
            self.client.get("/openApi/spot/v1/account/balance", params=params),
            QueryAssetsResponse,
        )
    ...
    def transfer_asset(
        ...
        return self.client.save_convert(
            self.client.post("/openApi/api/v3/post/asset/transfer", params=params),
            AssetTransferResponse,
        )

    def get_transfer_asset_records(
        self,
        transfer_type: TransferDirection,
        ...
        return self.client.save_convert(
            self.client.get("/openApi/api/v3/asset/transfer", params=params),
            AssetTransferRecordsResponse,
        )

    def get_main_account_internal_transfer_records(
        self,
        coin: str,
    ...
    def get_asset_overview(
        ...
        return self.client.save_convert(
            self.client.get("/openApi/account/v1/allAccountBalance", params=params),
            AssetOverviewResponse,
        )
