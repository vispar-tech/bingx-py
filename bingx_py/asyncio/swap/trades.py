...
from bingx_py.models.swap.trades import (
    ApplyVstResponse,
...
class TradesAPI:
    ...
    async def place_order_in_demo_trading(
        self,
        request: OrderRequest,
        recv_window: Optional[int] = None,
    ) -> PlaceOrderInDemoTradingResponse:
        ...
        return self.client.save_convert(
            await self.client.async_post("/openApi/swap/v2/trade/order", params=params),
            PlaceOrderInDemoTradingResponse,
        )
    ...
    async def cancel_order(
        ...
        return self.client.save_convert(
            await self.client.async_delete(
    ...
    async def get_current_all_open_orders(
        self,
        symbol: Optional[str] = None,
        order_type: Optional[OrderType] = None,
        recv_window: Optional[int] = None,
    ...
    async def query_pending_order_status(
        self,
        symbol: str,
        order_id: Optional[int] = None,
        client_order_id: Optional[str] = None,
    ...
    async def query_order_details(
        ...
        return self.client.save_convert(
            await self.client.async_get("/openApi/swap/v2/trade/order", params=params),
            QueryOrderDetailsResponse,
        )

    async def query_margin_type(
        self,
        symbol: str,
        recv_window: Optional[int] = None,
    ) -> QueryMarginTypeResponse:
    ...
    async def query_leverage_and_available_positions(
        self,
        symbol: str,
        recv_window: Optional[int] = None,
    ) -> QueryLeverageAndAvailablePositionsResponse:
    ...
    async def get_trading_historical_orders(
        self,
        trading_unit: str,
        start_ts: int,
        end_ts: int,
    ...
    async def position_and_maintenance_margin_ratio(
        self,
        symbol: str,
        recv_window: Optional[int] = None,
    ) -> PositionAndMaintenanceMarginRatioResponse:
    ...
    async def query_historical_transaction_details(
        self,
        symbol: str,
        start_ts: int,
        end_ts: int,
    ...
    async def isolated_margin_change_history(
        self,
        symbol: str,
        position_id: str,
        start_time: int,
    ...
    async def place_twap_order(
        ...
        return self.client.save_convert(
            await self.client.async_post("/openApi/swap/v1/twap/order", params=params),
            PlaceTwapOrderResponse,
        )

    async def query_twap_entrusted_order(
        self,
        symbol: Optional[str] = None,
        recv_window: Optional[int] = None,
    ) -> QueryTwapEntrustedOrderResponse:
    ...
    async def query_twap_historical_orders(
        self,
        page_index: int,
        page_size: int,
        start_time: int,
    ...
    async def query_twap_order_details(
        self,
        main_order_id: str,
        recv_window: Optional[int] = None,
    ) -> QueryTwapOrderDetailsResponse:
    ...
    async def switch_multi_assets_mode(
        self,
        asset_mode: str,
        recv_window: Optional[int] = None,
    ) -> SwitchMultiAssetsModeResponse:
    ...
    async def query_multi_assets_mode(
        self,
        recv_window: Optional[int] = None,
    ) -> QueryMultiAssetsModeResponse:
    ...
    async def query_multi_assets_rules(
        self,
        recv_window: Optional[int] = None,
    ) -> QueryMultiAssetsRulesResponse:
    ...
    async def query_multi_assets_margin(
        self,
        recv_window: Optional[int] = None,
    ) -> QueryMultiAssetsMarginResponse:
    ...
    async def one_click_reverse_position(
        self,
        reverse_type: str,
        symbol: str,
    ...
    async def hedge_mode_auto_add_margin(
        self,
        symbol: str,
        position_id: int,
        function_switch: str,
