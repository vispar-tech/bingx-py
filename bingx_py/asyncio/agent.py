...
from bingx_py.models.agent import (
    CommissionBizType,
...
class AgentAPI:
    ...
    async def daily_commission_query(
        self,
        start_time: str,
        end_time: str,
        pagination: PaginationParams,
    ...
    async def query_agent_user_information(
        self,
        uid: int,
    ) -> QueryAgentUserInformationResponse:
    ...
    async def query_deposit_details_of_invited_users(
        self,
        uid: int,
        biz_type: int,
        start_time: int,
    ...
    async def query_api_transaction_commission_non_invitation(
        self,
    ...
    async def query_partner_information(
        self,
        start_time: int,
        end_time: int,
        pagination: PaginationParams,
